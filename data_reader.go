...
// RawRead reads the TELNET escaped data from the  wrapped io.Reader, and "un-escapes" it into 'data'.
func (r *internalDataReader) RawRead(data []byte) (n int, err error) {
